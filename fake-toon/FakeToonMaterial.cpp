...
FakeToonMaterial::FakeToonMaterial(const std::string &name)
  : Ra::Engine::Material( name )
{
  ...
  Ra::Engine::EngineRenderTechniques::registerDefaultTechnique(
      ...
      []( Ra::Engine::RenderTechnique& rt, bool /*isTransparent*/ ) {
          ...
          Ra::Engine::ShaderConfiguration lpconfig(
              "FakeToon", "Plugins/FakeToon/Shaders/VERTEX_SHADER.vert",
          ...
          Ra::Engine::ShaderConfiguration dpconfig(
              "DepthAmbiantFakeToon", "Plugins/FakeToon/Shaders/VERTEX_SHADER.vert",
              "Plugins/FakeToon/Shaders/FRAGMENT_SHADER.frag" );
